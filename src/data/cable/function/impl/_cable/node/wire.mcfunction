function ./wire/summon:
    ...
    execute align xyz unless entity @e[limit=1,dx=0,type=item_display,tag=cable.core,predicate=cable:same_type] run function ./core/add
...
function ./wire/destroy:
    ...
    execute at @s positioned ^ ^ ^1 align xyz as @e[dx=0,limit=1,type=item_display,tag=cable.wire,predicate=cable:same_type,predicate=cable:opposite_direction] at @s run function ./wire/destroy_2
    execute at @s run function ./wire/destroy_2:
        ...
        execute align xyz unless entity @e[limit=1,dx=0,type=item_display,tag=cable.wire,tag=!cable.core,predicate=cable:same_type] run return run function ./core/summon
        execute align xyz as @e[limit=1,dx=0,type=item_display,tag=cable.wire,tag=!cable.core,predicate=cable:same_type] run function ./core/add
        kill @s