...
# Register
function ./register { type:"redstone", components:{ item_name:'Redstone Cable', item_model:"cable:redstone_cable" }}
function ./register { type:"item", components:{ item_name:'Item Cable', item_model:"cable:item_cable" }}

function ./register { type:"energy", components:{ item_name:'Energy Cable', item_model:"cable:energy_cable" }}
function ./register { type:"enhanced_energy",tier:"enhanced", components:{ item_name:'Enhanced Energy Cable', item_model:"cable:enhanced_energy_cable" }}
function ./register { type:"ender_energy",tier:"ender", components:{ item_name:'Ender Energy Cable', item_model:"cable:ender_energy_cable" }}

function ./register { type:"fluid", components:{ item_name:'Fluid Cable', item_model:"cable:fluid_cable" }}
function ./register { type:"pressurized_fluid",tier:"pressurized", components:{ item_name:'Pressurized Fluid Cable', item_model:"cable:pressurized_fluid_cable" }}
function ./register { type:"ender_fluid",tier:"ender", components:{ item_name:'Ender Fluid Cable', item_model:"cable:ender_fluid_cable" }}
