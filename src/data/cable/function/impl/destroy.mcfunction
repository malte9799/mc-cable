...
execute as @e[dx=0,type=item_display,tag=cable.cable,predicate=cable:same_type] run function ./destory/network:
	...
	execute rotated as @s positioned ^ ^ ^1 as @e[limit=1,dx=0,type=item_display,tag=cable.network,predicate=cable:same_type,predicate=cable:opposite_direction] run function ./destroy/network_2:
		...
		execute unless entity @e[limit=1,dx=0,type=item_display,tag=cable.cable,tag=!cable.core] run return run function ./place/core
		execute as @e[limit=1,dx=0,type=item_display,tag=cable.cable,tag=!cable.core] run function ./destory/init_core:
