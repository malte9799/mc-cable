...
function ./interaction/on_left_click:
    scoreboard players operation #predicate cable.type = @s cable.type
    scoreboard players operation #predicate cable.direction = @s cable.direction
    execute at @s[tag=cable.interaction.core] align xyz as @e[limit=1,dx=0,type=item_display,tag=cable.core,predicate=cable:same_type] run function ./destroy
    execute at @s[tag=cable.interaction.wire] align xyz as @e[limit=1,dx=0,type=item_display,tag=cable.wire,predicate=cable:same_type,predicate=cable:same_direction] run function ./destroy_wire
