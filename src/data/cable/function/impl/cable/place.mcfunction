...
execute align xyz store result score #count cable.math if entity @e[dx=0,tag=cable.core,type=item_display]
...
execute align xyz positioned ~1 ~ ~ as @e[limit=1,dx=0,tag=cable.core,predicate=cable:same_type,type=item_display] rotated -90 0 positioned ~.5 ~.5 ~.5 run function ./place/wire
scoreboard players set #predicate cable.direction -1 # west
execute align xyz positioned ~-1 ~ ~ as @e[limit=1,dx=0,tag=cable.core,predicate=cable:same_type,type=item_display] rotated 90 0 positioned ~.5 ~.5 ~.5 run function ./place/wire
scoreboard players set #predicate cable.direction 2 # up
execute align xyz positioned ~ ~1 ~ as @e[limit=1,dx=0,tag=cable.core,predicate=cable:same_type,type=item_display] rotated 0 -90 positioned ~.5 ~.5 ~.5 run function ./place/wire
scoreboard players set #predicate cable.direction -2 # down
execute align xyz positioned ~ ~-1 ~ as @e[limit=1,dx=0,tag=cable.core,predicate=cable:same_type,type=item_display] rotated 0 90 positioned ~.5 ~.5 ~.5 run function ./place/wire
scoreboard players set #predicate cable.direction 3 # south
execute align xyz positioned ~ ~ ~1 as @e[limit=1,dx=0,tag=cable.core,predicate=cable:same_type,type=item_display] rotated 0 0 positioned ~.5 ~.5 ~.5 run function ./place/wire
scoreboard players set #predicate cable.direction -3 # north
execute align xyz positioned ~ ~ ~-1 as @e[limit=1,dx=0,tag=cable.core,predicate=cable:same_type,type=item_display] rotated 180 0 positioned ~.5 ~.5 ~.5 run function ./place/wire
...
function ./place/wire:
    ...
    execute facing ^ ^ ^-1 align xyz as @e[limit=1,dx=0,tag=cable.core,tag=!cable.wire,predicate=cable:same_type,type=item_display] run return run function ./place/wire_2
