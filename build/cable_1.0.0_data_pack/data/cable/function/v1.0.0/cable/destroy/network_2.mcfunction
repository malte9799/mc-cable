...
execute unless entity @e[limit=1, dx=0, type=item_display, tag=cable.cable, tag=!cable.core, predicate=cable:same_type] rotated 0 0 run return run function cable:v1.0.0/cable/place/core
