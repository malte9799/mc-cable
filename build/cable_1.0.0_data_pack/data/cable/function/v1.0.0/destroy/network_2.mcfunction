...
execute unless entity @e[limit=1, dx=0, type=item_display, tag=cable.cable, tag=!cable.core] run return run function cable:v1.0.0/place/core
execute as @e[limit=1, dx=0, type=item_display, tag=cable.cable, tag=!cable.core] run function cable:v1.0.0/destory/init_core
