#> cable:v1.0.0/destroy/network_3
#
# @context align xyz
# @input
...
execute at @s[tag=cable.cable] positioned ^ ^ ^1 align xyz as @e[dx=0, type=item_display, tag=cable.network, tag=!cable.checked, predicate=cable:same_type] run function cable:v1.0.0/destroy/network_3
